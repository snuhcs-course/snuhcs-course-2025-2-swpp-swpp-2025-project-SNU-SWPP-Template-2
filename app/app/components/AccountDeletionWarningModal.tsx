...
interface AccountDeletionWarningModalProps {
  visible: boolean
  onCancel: () => void
  onConfirm: () => void
}

export const AccountDeletionWarningModal: React.FC<AccountDeletionWarningModalProps> = ({
  visible,
  onCancel,
  onConfirm,
}) => {
      ...
      <View style={$overlay}>
        <View style={$container}>
          ...
          <View style={$iconContainer}>
            <AlertTriangle size={48} color="#f66c51" />
          </View>

          {/* Title */}
          <Text style={$title}>계정 탈퇴</Text>
          ...
          <View style={$buttonContainer}>
            ...
            <TouchableOpacity style={$confirmButton} onPress={onConfirm}>
              <Text style={$confirmButtonText}>탈퇴하기</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
