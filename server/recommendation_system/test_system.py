...
이 스크립트는 추천 시스템의 주요 기능을 테스트합니다.
"""

import json
import logging
from recommendation_system.user_profile import create_sample_user_profile
from recommendation_system.scoring import create_sample_search_context
...
def test_scoring_weights():
    ...
    try:
        from recommendation_system.scoring import ScoringWeights, HybridScorer
...
def test_mmr_reranking():
    ...
    try:
        from recommendation_system.scoring import MMRReranker
